  ...
  return (
    <div className="container" style={{ padding: '20px'}}>
      <Row gutter={[24, 24]}>
        {/* Left Column */}
        <Col xs={24} md={16}>
          <div className="left-container" style={{ fontSize: 20, lineHeight: 1.5}}>
            <p style={{ marginBottom: 20 }}>
              Lái thử xe là một bước rất quan trọng trong việc quyết định chọn mua xe khi bạn tham gia lái thử tại{' '}
              <Link href={"/"}>Hyundai Đà Nẵng</Link> chúng tôi bạn sẽ nhận được những ưu đãi như:
            </p>
        ...
        <Col xs={24} md={8}>
          ...
          >
            ...
            <p style={{ color: '#0073b7', margin: '10px 0 0' }}>
              Mr.Quang Trường <span style={{ color: 'red', fontWeight: 'bold' }}>0906 557 408</span>
            </p>
            <p style={{ fontWeight: 'bold', marginBottom: '15px' }}>Phụ trách kinh doanh</p>
